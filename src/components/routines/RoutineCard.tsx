 ...
 *  • ปุ่ม Play / Pause / Done + Edit (Modal) + Delete
 *  • จับเวลา ↔ PATCH progressSec ทุก 15 s + ตอน pause / unmount / finish
 * ----------------------------------------------------------------*/
...
import EditRoutineModal from "./EditRoutineModal";         // ← modal แก้ไข
  ...
  return (
    <>
      ...
      <EditRoutineModal
        open={editOpen}
        setOpen={setEditOpen}
        routine={{ id, title, durationSec, weekdays: weekdays ?? [] }}
